...
if(!firebase.apps.length){
  firebase.initializeApp({
    apiKey: "AIzaSyClSP9UA4ZpFH1FVSbtFkYYHlv_KciX_6Y",
    authDomain: "teq-ui-ero.firebaseapp.com",
    databaseURL: "https://teq-ui-ero-default-rtdb.firebaseio.com",
    projectId: "teq-ui-ero",
    storageBucket: "teq-ui-ero.appspot.com",
    messagingSenderId: "838876602796",
    appId: "1:838876602796:web:e61d38d8fb28d028591a09",
    measurementId: "G-LVGXR8ZV0G"
  });
}else{
  firebase.app()
}
...
function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://www.instagram.com/her_reddy_cules/">
          <img src={brandLogo} alt="her_reddy_cules" width={80} />
        </a>
